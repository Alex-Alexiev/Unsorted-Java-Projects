	...
	public void setup() {
		...
		for (int i = 0; i < num_of_asteroids; i++) {
			...
			asteroids.add(new Asteroids(this, (int) random(30, width - 30), (int) random(30, height - 30), 100, 100,
					(int) random(1, 2) * negator, (int) random(1, 2) * negator, new Color(255, 255, 255),
					new Color(0, 0, 0), 5));
		}
		...
		spaceship = new movingTriangle(this, vertices, new PVector(0, 1), (float) 0.0, (float) 0.0, new Color(255, 255, 255),
				new Color(0, 0, 0), 2);

		int negator = ((int) random(0, 1) == 0 ? -1 : 1);

		shot = new Projectiles(this, 10, 10, 10, 10, (int) random(1, 2) * negator, (int) random(1, 2) * negator,
				new Color(255, 255, 255), new Color(0, 0, 0), 5);
	}
