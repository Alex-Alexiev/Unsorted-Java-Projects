...
public class Test {
	...
	public static void main(String[] args) {
		...
		System.loadLibrary("opencv_java310.jar");
      ...
      {  
        ...
        if( !webcam_image.empty() )  
         {  
          ...
          //Imgprocline(hsv_image, new Point(150,50), new Point(202,200), new Scalar(100,10,10)CV_BGR(100,10,10), 3);  
